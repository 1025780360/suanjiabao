    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='materials.materialcategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_type', models.CharField(choices=[('fabric', 'Fabric'), ('accessory', 'Accessory'), ('packaging', 'Packaging'), ('other', 'Other')], max_length=30)),
                ('default_loss_rate', models.DecimalField(decimal_places=4, default=0, max_digits=6)),
